...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // Deliverable 3: 1. Create a variable that filters the metadata array for the object with the desired sample number. DEL
    var metadata = data.metadata;
    ...
    // Deliverable 3: 2. Create a variable that holds the first sample in the metadata array. DEL
